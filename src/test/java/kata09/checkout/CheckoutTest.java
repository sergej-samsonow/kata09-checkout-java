...
public class CheckoutTest {
    ...
    private Rules rules() throws Exception {
        ...
        rules.setProcessing(
                new String(Files.readAllBytes(Paths.get(getClass().getResource("/script.source").toURI()))));
    ...
    /**
     * This method and all testTotal* methods reflects the kata test
     * requirements.
     *
     * @see <a href=
     *      "http://codekata.com/kata/kata09-back-to-the-checkout/">Tescase
     *      TestPrice.test_totals</a>
     *
     * @throws Exception
     */
