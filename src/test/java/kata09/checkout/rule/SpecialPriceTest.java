...
public class SpecialPriceTest {
	...
	public void testGroupProductsSpeical2and3to5() throws Exception {
		price.add("A", 2, 40);
		price.add("A", 3, 55);
		assertThat(price.groupProducts(asList("A", "A", "A", "A", "A"))).isEqualTo(asList(amount("A", 3), amount("A", 2)));
	}
	...
	public void testGroupProductsSpeical2and3to6() throws Exception {
		price.add("A", 2, 40);
		price.add("A", 3, 55);
		assertThat(price.groupProducts(asList("A", "A", "A", "A", "A", "A"))).isEqualTo(asList(amount("A", 3), amount("A", 3)));
	}
	...
	public void testGroupProductsSpeical2and3to7() throws Exception {
		price.add("A", 2, 40);
		price.add("A", 3, 55);
		assertThat(price.groupProducts(asList("A", "A", "A", "A", "A", "A", "A"))).isEqualTo(asList(amount("A", 3), amount("A", 3), amount("A", 1)));
	}
	...
	public void testGroupProductsSpeical2and3to8() throws Exception {
		price.add("A", 2, 40);
		price.add("A", 3, 55);
		assertThat(price.groupProducts(asList("A", "A", "A", "A", "A", "A", "A", "A"))).isEqualTo(asList(amount("A", 3), amount("A", 3), amount("A", 2)));
	}
	...
	public void testGroupProductsSpeical4and2to7() throws Exception {
		price.add("A", 4, 40);
		price.add("A", 2, 55);
		assertThat(price.groupProducts(asList("A", "A", "A", "A", "A", "A", "A"))).isEqualTo(asList(amount("A", 4), amount("A", 2), amount("A", 1)));
	}
	...
	public void testGroupProductsSpeical4and2to8() throws Exception {
		price.add("A", 4, 40);
		price.add("A", 2, 55);
		assertThat(price.groupProducts(asList("A", "A", "A", "A", "A", "A", "A", "A"))).isEqualTo(asList(amount("A", 4), amount("A", 4)));
	}
	...
	public void testGroupProductsSpeical4and2to8and2b() throws Exception {
		price.add("A", 4, 40);
		price.add("A", 2, 55);
		assertThat(price.groupProducts(asList("A", "A", "A", "A", "A", "A", "A", "A", "B", "B"))).isEqualTo(asList(amount("A", 4), amount("A", 4), amount("B", 2)));
	}
